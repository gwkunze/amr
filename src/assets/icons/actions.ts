import esunaIcon from '../../../img/action/esuna.png';
import tailScrewIcon from '../../../img/action/tail-screw.png';
...
export const Actions: ImageSet = new Map([
    ['Esuna', esunaIcon],
    ['Tail Screw', tailScrewIcon],
    ['Ink Jet', inkJetIcon],
